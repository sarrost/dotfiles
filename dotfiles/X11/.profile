...
export RICE_SCRIPTS_REPO_DIR="$RICE_REPO_DIR"/sh
export RICE_SCRIPTS_DIR="$RICE_SCRIPTS_REPO_DIR"/scripts
export RICE_DOTFILES_REPO_DIR="$RICE_REPO_DIR"/dt
export RICE_DOTFILES_DIR="$RICE_DOTFILES_REPO_DIR"/dotfiles
